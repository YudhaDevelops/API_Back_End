        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Hallo, Selamat Siang</h5>
                        @if (session('resent'))
                        ...
                        <a href="http://localhost:8000/reset-pass/{{$token}}" class="btn btn-primary">Atur Ulang Password</a>
                        ...
                        <!-- <strong> | Tempat Replay Kuliah Terbaik</strong>  -->
                        <!-- <blockquote class="blockquote mb-0">
                            <footer class="blockquote-footer"><cite title="Source Title">Tempat Replay Kuliah Terbaik</cite></footer>
                        </blockquote> -->
                    </div>
                </div>
            </div>
